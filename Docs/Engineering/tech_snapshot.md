...
**Last refreshed:** 2026-05-04 by HoE Session 2 (Day-4: Investigator agent body + Wire vocabulary consumers + HND end-to-end test + boot-warning filters shipped. **Full Editor → Scout → Investigator dispatch chain verified live against GCP.** 151 unit tests + 1 skipped.)
